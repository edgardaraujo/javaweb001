...
public class AuthenticationFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		// mesmo comando de baixo em uma linha, o de duas linha é mais claro
		// String user
		// =(String)((HttpServletRequest)request).getSession().getAttribute("user");
		logger.debug("Antes de passar no filtro");
